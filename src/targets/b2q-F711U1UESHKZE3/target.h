...
#else
#define BUILD_VARIANT_LABEL "b2q-F711U1UESHKZE3-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/b2quew/b2q:15/AP3A.240905.015.A2/F711U1UESHKZE3:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/b2q-F711U1UESHKZE3/p0_fingerprint.h"
#endif
...
#define ASHMEM_FOPS_OFF 0x023f0278ULL
#define ASHMEM_IOCTL_OFF 0x001586f4ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00159014ULL
#define ASHMEM_MMAP_OFF 0x00159068ULL
#define ASHMEM_OPEN_OFF 0x0015920cULL
#define ASHMEM_RELEASE_OFF 0x00159284ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x001593e4ULL
#define CONFIGFS_READ_ITER_OFF 0x0058da10ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x0058dbc8ULL
#define COPY_SPLICE_READ_OFF 0x0050dd1cULL
#define NOOP_LLSEEK_OFF 0x004c4418ULL
#define INIT_TASK_OFF 0x02cd4780ULL
#define ROOT_TASK_GROUP_OFF 0x030e9470ULL
#define SELINUX_ENFORCING_OFF 0x025ea478ULL
#define KMALLOC_CACHES_OFF 0x0256f650ULL
#define ANON_PIPE_BUF_OPS_OFF 0x02418938ULL
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x002a01a4ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x02bdfa48ULL
