# target.h derivation report for a15x-S156VUDSCEZG1

- [DERIVED] KIMAGE_TEXT_BASE = 0xffffffc008000000 (recovered ELF PT_LOAD base)
- [DERIVED] BUILD_FINGERPRINT = samsung/a15xtfn/a15x:16/BP4A.251205.006/S156VUDSCEZG1:user/release-keys (--fingerprint input)
- [DERIVED] BUILD_VARIANT_LABEL (app) = a15x-S156VUDSCEZG1-app-physical-p0-oracle
- [DERIVED] BUILD_VARIANT_LABEL (root) = a15x-S156VUDSCEZG1-root-umh
- [DERIVED] P0_FINGERPRINT_HEADER = targets/a15x-S156VUDSCEZG1/p0_fingerprint.h
- [DERIVED] ASHMEM_FOPS_OFF = 0x1ec7ba0 (nm ashmem_fops - base)
- [DERIVED] ASHMEM_IOCTL_OFF = 0x1059670 (nm ashmem_ioctl - base)
- [DERIVED] ASHMEM_COMPAT_IOCTL_OFF = 0x1059ccc (nm compat_ashmem_ioctl - base)
- [DERIVED] ASHMEM_MMAP_OFF = 0x1059d24 (nm ashmem_mmap - base)
- [DERIVED] ASHMEM_OPEN_OFF = 0x105a004 (nm ashmem_open - base)
- [DERIVED] ASHMEM_RELEASE_OFF = 0x105a09c (nm ashmem_release - base)
- [DERIVED] ASHMEM_SHOW_FDINFO_OFF = 0x105a1b8 (nm ashmem_show_fdinfo - base)
- [DERIVED] CONFIGFS_READ_ITER_OFF = 0x5d22a8 (nm configfs_read_iter - base)
- [DERIVED] CONFIGFS_BIN_WRITE_ITER_OFF = 0x5d2cd0 (nm configfs_bin_write_iter - base)
- [DERIVED] COPY_SPLICE_READ_OFF = 0x525eb8 (nm generic_file_splice_read - base)
- [DERIVED] NOOP_LLSEEK_OFF = 0x4ba3e8 (nm noop_llseek - base)
- [DERIVED] INIT_TASK_OFF = 0x2a49080 (nm init_task - base)
- [DERIVED] ROOT_TASK_GROUP_OFF = 0x2af9ac0 (nm root_task_group - base)
- [DERIVED] KMALLOC_CACHES_OFF = 0x1f1ea48 (nm kmalloc_caches - base)
- [DERIVED] ANON_PIPE_BUF_OPS_OFF = 0x1d5e5e0 (nm anon_pipe_buf_ops - base)
- [DERIVED] CALL_USERMODEHELPER_EXEC_WORK_OFF = 0x104598 (nm call_usermodehelper_exec_work - base)
- [INFO] SYSTEM_UNBOUND_WQ_OFF = 0x28e07d8 (nm system_unbound_wq - base) already correct in template; kept as-is
- [INFO] SLIDE_NFULNL_LOGGER_OBJECT_OFF = 0x28e1e28 (nm nfulnl_logger - base) already correct in template; kept as-is
- [DERIVED] SLIDE_SYSCTL_BOOTID_OFF = 0x2cafaa1 (nm sysctl_bootid - base)
- [DERIVED] ASHMEM_MISC_FOPS_OFF = 0x2a40ea8 (nm ashmem_misc + BTF miscdevice.fops)
- [DERIVED] SELINUX_ENFORCING_OFF = 0x2bcded8 (nm selinux_state + BTF selinux_state.enforcing)
